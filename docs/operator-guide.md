...
2. Define consent and purpose categories for glazier/site records.
...
- safety-critical escalation path (glass-handling risk, height-work
  risk, panel-hazard)
- provenance for all operating records (glazier and site both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  glazing-installation-execution decision, or a site-safety-officer
  override decision, through this actor — those decisions stay the
  site safety officer's exclusive authority end to end
